    ...
    <div class='container-login'>
        <div class="login">
            ...
            <form action="?controller=user&action=doregister" method="post">
                ...
                <input class="input-login" type="pass" placeholder="Contraseña" name="pass" id="pass">
                <input class="input-login" type="pass" placeholder="Repetir Contraseña" name="rpass" id="rpass">
